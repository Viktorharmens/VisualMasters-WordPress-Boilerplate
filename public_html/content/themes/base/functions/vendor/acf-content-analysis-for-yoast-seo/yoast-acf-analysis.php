...
if ( ! defined( 'AC_SEO_ACF_ANALYSIS_PLUGIN_PATH' ) ) {
	...
	define( 'AC_SEO_ACF_ANALYSIS_PLUGIN_SLUG', 'acf-content-analysis-for-yoast-seo' );
	define( 'AC_SEO_ACF_ANALYSIS_PLUGIN_FILE', __FILE__ );
	define( 'AC_SEO_ACF_ANALYSIS_PLUGIN_PATH', get_template_directory() . '/functions/vendor/acf-content-analysis-for-yoast-seo/' );
	define( 'AC_SEO_ACF_ANALYSIS_PLUGIN_URL', get_stylesheet_directory_uri() . '/functions/vendor/acf-content-analysis-for-yoast-seo/' );
